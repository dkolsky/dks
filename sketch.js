...
let groupData = [
    {
      ...
      images: [
        { file: 'https://raw.githubusercontent.com/dkolsky/dks/main/dks-2025/images/triangle-base.png', offset: { xPct: 0.02, yPct: 0.01 }, z: 0 },
        { file: 'https://raw.githubusercontent.com/dkolsky/dks/main/dks-2025/images/triangle-light.png', offset: { xPct: 0, yPct: 0.03 }, z: 2 },
        { file: 'https://raw.githubusercontent.com/dkolsky/dks/dks-2025/images/triangle-dark.png', offset: { xPct: 0.02, yPct: 0.0 }, z: 1 }
      ]
    },
    {
      name: 'circle',
      ...
      images: [
        { file: 'https://raw.githubusercontent.com/dkolsky/dks/main/dks-2025/images/circle-base.png', offset: { xPct: 0.03, yPct: 0.01 }, z: 0 },
        { file: 'https://raw.githubusercontent.com/dkolsky/dks/main/dks-2025/images/circle-light.png', offset: { xPct: 0.01, yPct: -0.01 }, z: 2 },
        { file: 'https://raw.githubusercontent.com/dkolsky/dks/main/dks-2025/images/circle-dark.png', offset: { xPct: 0.05, yPct: 0.04 }, z: 1 }
      ]
    },
    {
      name: 'square',
      ...
      images: [
        { file: 'https://raw.githubusercontent.com/dkolsky/dks/main/dks-2025/images/square-base.png', offset: { xPct: 0, yPct: 0 }, z: 0 },
        { file: 'https://raw.githubusercontent.com/dkolsky/dks/main/dks-2025/images/square-light.png', offset: { xPct: 0.0, yPct: -0.0 }, z: 2 },
        { file: 'https://raw.githubusercontent.com/dkolsky/dks/main/dks-2025/images/square-dark.png', offset: { xPct: -0.02, yPct: -0.01 }, z: 1 }
      ]
    }
  ];
  ...
  function preload() {
    ...
    for (let group of groupData) {
      for (let img of group.images) {
        img.img = loadImage(img.file); // This is correct, assuming groupData URLs are correct
      }
    }
  
    // Load small images
    for (let i = 1; i <= 9; i++) {
      let imgPath = `https://raw.githubusercontent.com/dkolsky/dks/main/dks-2025/images/small/small-set-${nf(i, 2)}-base.png`;
